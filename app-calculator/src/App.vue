<template>
  <div class="container mt-4">
    <div class="calc container ml-4 p-2 bg-secondary">
      ...
      <div class="row">
        <button type="button" class="btn btn-dark btn-lg">C</button>
        <button type="button" class="btn btn-dark btn-lg">CE</button>
      ...
      <div class="row">
        <button type="button" class="btn btn-dark btn-lg btn-zero">0</button>
        <button type="button" class="btn btn-dark btn-lg">.</button>
        <button type="button" class="btn btn-dark btn-lg">=</button>
      </div>
    </div>
